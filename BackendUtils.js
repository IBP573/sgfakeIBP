...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `StumbleFake<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "StumbleFake 1v1",
      descriptionKey: "Practice your skills in the StumbleFake 1v1 TournamentX! mode!",
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "StumbleFake 2v2 ",
      descriptionKey: "Practice your skills in the Stumble Fake 2v2 TournamentX! mode!",
      ...
      colourData: {
        ...
        infoWidgetsGradientLeft: "hsl(115, 100%, 55%)",
